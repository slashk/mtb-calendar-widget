...
The most current version of MTBcalendar widget is 0.43 and is available at "http://blog.mtbcalendar.com/wp-content/uploads/2008/12/mtbcalendar_v043.zip":http://blog.mtbcalendar.com/wp-content/uploads/2008/12/mtbcalendar_v043.zip.
...
This widget will allow you to see upcoming MTB events that have been entered on the "mtbcalendar.com":http://www.mtbcalendar.com site.

The only preference setting on this widget is accessible via the back panel  (click the (i) icon in the lower right hand corner to show). It is a pulldown  menu which lists different regions so that you can find races closest to where  you live. It defaults to "Northern California" (_hells yeah_) but you can set  it to any region you choose. The regions are mostly small cluster of states, but some states are split (like California).

To see more details about any race event, simply click on the events name on the  front panel and it will take you to the appropriate page on the "MTB Calendar":http://www.mtbcalendar.com/ website.
...
This widget was created with Apple's "Dashcode":http://www.apple.com/macosx/developertools/dashcode.html and follows most of their setup conventions. However, I have added "Prototype javascript library":http://www.prototypejs.org/ (version 1.6.0.3). 

The source is available via my "GitHub account":http://slashk.github.com/.

h3. Author

This dashboard widget was created by "/k":http://slashk.github.com/ for the "MTBcalendar":http://www.mtbcalendar.com website. /k also writes the "NorCal MTB Racing Blog":http://norcalmtnbikeracing.blogspot.com/ and occasionally gets to ride his bike.
